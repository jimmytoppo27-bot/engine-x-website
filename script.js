...
const ENGINE_CATEGORIES = [
  { icon: '⚙️', name: 'Machines', description: 'Core mechanisms, engines and moving parts that power everyday devices.', link: 'pages/topic.html?topic=machines', category: 'Machines' },
  { icon: '💡', name: 'Innovation', description: 'Emerging ideas and breakthroughs reshaping how things are engineered.', link: 'pages/topic.html?topic=innovation', category: 'Innovation' },
  { icon: '💻', name: 'Technology', description: 'Software, sensors and smart systems behind modern engineering.', link: 'pages/topic.html?topic=technology', category: 'Technology' },
  { icon: '🚗', name: 'Automobile', description: 'Engines, drivetrains and the systems that make vehicles run.', link: 'pages/topic.html?topic=automobile', category: 'Automobile' },
  { icon: '🚀', name: 'Space', description: 'Rockets, propulsion and the hardware that leaves the atmosphere.', link: 'pages/topic.html?topic=space', category: 'Space' },
  { icon: '🚢', name: 'Marine', description: 'Ship engines, propulsion and engineering beneath the waves.', link: 'pages/topic.html?topic=marine', category: 'Marine' }
];
